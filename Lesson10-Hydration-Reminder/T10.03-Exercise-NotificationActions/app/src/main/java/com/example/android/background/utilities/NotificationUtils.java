...
public class NotificationUtils {
    ...
    private static final int ACTION_IGNORE_PENDING_INTENT_ID= 342342;

    private static final int ACTION_DRINK_WATER_PENDING_INTENT_ID= 33242;
    /**
    ...
    public static NotificationCompat.Action ignoreReminderAction(Context context){
        ...
        PendingIntent ignoreReminderPendingIntent = PendingIntent.getService(context,ACTION_IGNORE_PENDING_INTENT_ID, dismissNotification,PendingIntent.FLAG_UPDATE_CURRENT);
    ...
    public static NotificationCompat.Action drinkWaterAction(Context context){
        ...
        PendingIntent drinkWaterPendingIntent = PendingIntent.getService(context,ACTION_DRINK_WATER_PENDING_INTENT_ID,drinkWaterIntent,PendingIntent.FLAG_UPDATE_CURRENT);
