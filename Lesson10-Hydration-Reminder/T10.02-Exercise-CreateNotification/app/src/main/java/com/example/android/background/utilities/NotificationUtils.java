...
public class NotificationUtils {
    ...
    public static final int WATER_REMINDER_PENDING_INTENT_ID = 1332343;

    public static final String WATER_REMINDER_NOTIFICATION_CHANNEL_ID = "WATER_REMINDER_CHANNEL";
